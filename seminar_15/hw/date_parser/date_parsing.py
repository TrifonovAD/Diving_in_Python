...
# from date_except import ParceDaysExceptions, WrongFormatDate, WeekNumberError, WeekDayNameError, \
#     MonthNameError

from .date_except import ParceDaysExceptions, WrongFormatDate, \
    WeekNumberError, WeekDayNameError, MonthNameError
...
class TextToDate:
    ...
    def _calc_date(self) -> None | ParceDaysExceptions:
        ...
        if week_no not in range(self._WEEK_NO_MIN, self._WEEK_NO_MAX+1):
